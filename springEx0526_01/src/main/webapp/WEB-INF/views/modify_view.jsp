...
<html>
  ...
  <link rel="stylesheet" href="css/write.css">
    ...
    <form action="modify.do" name="modify" method="post">
      ...
      <input type = "hidden" name = "bGroup" value = "${modify_view.bGroup}">
      <input type = "hidden" name = "bStep" value = "${modify_view.bStep}">
      <input type = "hidden" name = "bIndent" value = "${modify_view.bIndent}">
        <colgroup>
          <col width="15%">
          <col width="85%">
        </colgroup>
